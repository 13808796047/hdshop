...
<div id="content">
	<table id="table" class='table1'>
		...
		<tbody>
		<?php $hd["list"]["v"]["total"]=0;if(isset($locality) && !empty($locality)):$_id_v=0;$_index_v=0;$lastv=min(1000,count($locality));
$hd["list"]["v"]["first"]=true;
$hd["list"]["v"]["last"]=false;
$_total_v=ceil($lastv/1);$hd["list"]["v"]["total"]=$_total_v;
$_data_v = array_slice($locality,0,$lastv);
...
if($_index_v>=$_total_v):$hd["list"]["v"]["last"]=true;endif;?>
			...
			<tr class="level_<?php echo $v['_level'];?> pid_<?php echo $v['pid'];?>" cid="<?php echo $v['lid'];?>" level="<?php echo $v['level'];?>">
