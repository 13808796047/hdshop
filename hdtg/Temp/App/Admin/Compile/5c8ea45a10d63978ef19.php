...
<script type="text/javascript" src='http://127.0.0.1/hdshop/hdtg/App/Admin/Tpl/Public/js/locality.js'></script>
<div id="map">
...
if($_index_v>=$_total_v):$hd["list"]["v"]["last"]=true;endif;?>
								...
								<option value='<?php echo $v['lid'];?>'><?php echo $v['_name'];?></option>
