...
echo "";
				...
				<tr>
					<td>分类标题</td>
					<td>
						<input type ='text' name='title' value='<?php echo $category['title'];?>'></td>
				</tr>
				<tr>
					<td>分类关键字</td>
					<td>
						<input type='text' name ='keywords' class='w300' value='<?php echo $category['keywords'];?>'></td>
				</tr>
				<tr>
					<td>分类描述</td>
					<td>
						<textarea  class='w300 h100' name="description" ><?php echo $category['description'];?></textarea>
					</td>
				</tr>
				<tr>
					<td>分类排序</td>
