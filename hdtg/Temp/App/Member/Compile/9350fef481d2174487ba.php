...
<body>
	...
	<!-- 载入公共头部文件-->
	<link href="http://127.0.0.1/hdshop/hdtg/App/Member/Tpl/Public/css/reg.css" type="text/css" rel="stylesheet" >
	<script src='http://127.0.0.1/hdshop/hdtg/App/Member/Tpl/Public/js/regCheck.js'></script>
	<script type="text/javascript">
		function changeCode(){
			var src = '<?php echo U('Member/Reg/showCode');?>/mt/'+Math.random();
			$(this).attr('src',src);
		}
		var __JSCONTROL__='http://127.0.0.1/hdshop/index.php/Member/Reg';
	...
	<div id="regBox">
		...
		<form action="<?php echo U('Member/Reg/addUser');?>" method="post" id="regForm">
			...
			<dl>
				<dt>验证码</dt>
				<dd class='text code' style="width:200px;"><input ajax=1  class='must'  type="text"  name="code"/><img onclick='changeCode.call(this);' src="<?php echo U('Member/Reg/showCode');?>"></dd>
				<dd class='prompt'></dd>
			</dl>
			<dl>
				<dt></dt>
